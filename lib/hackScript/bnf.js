exports.bnf = {
  ...
  expr: [
    ["propertychain comparison 'INT'", "$$ = new yy.Expression(@2.first_line, @2.first_column, $1, $3);"],
    ["propertychain comparison propertychain", "$$ = new yy.Expression(@2.first_line, @2.first_column, $1, $3);"],
    ["INT comparison propertychain", "$$ = new yy.Expression(@2.first_line, @2.first_column, $1, $3);"],
    ["INT comparison INT", "$$ = new yy.Expression(@2.first_line, @2.first_column, $1, $3);"]
  ],
